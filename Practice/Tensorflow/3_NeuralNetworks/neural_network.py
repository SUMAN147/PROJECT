...
def neural_net(x_dict):
    x = x_dict['images']
    #Hidden fuly connected layer with 256 neurons
    layer_1 = tf.layers.dense(x,n_hidden_1)
    #Hidden fully connected laye r with 256 neurons
...
def model_fn(features, labels, mode):
    ...
    if mode == tf.estimator.ModeKeys.PREDICT:
     ...
     acc_op = tf.metrics.accuracy(labels = labels, predictiond = pred_classes)
